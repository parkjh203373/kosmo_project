        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container py-4">
                    <h1 class="h4 mb-4 text-gray-900 font-weight-bold">도서 정보 수정 아카이브</h1>
                                    ...
                                    <form action="./update" method="post" enctype="multipart/form-data" id="frm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 pl-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label class="font-weight-bold small text-dark" for="bookDate">출판일 정보</label>
                                                        <input type="date" name="bookDate" id="bookDate" class="form-control border-0 bg-light px-3" value="${d.bookDate}">
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label class="font-weight-bold small text-dark" for="bookStatus">현재 대출 상태 정의</label>
                                                        <select name="bookStatus" id="bookStatus" class="form-control border-0 bg-light text-secondary font-weight-medium">
                                                            <option value="대출가능" ${d.bookStatus eq '대출가능' ? 'selected' : ''}>🟢 대출 가능 상태</option>
                                                            <option value="대출중" ${d.bookStatus eq '대출중' ? 'selected' : ''}>🔴 현재 대출 중</option>
                                                            <option value="DNL" ${d.bookStatus eq 'DNL' ? 'selected' : ''}>⚙️ 관리 홀딩 (파손, 분실 등)</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mt-4">
                                            <label class="font-weight-bold small text-dark" for="bookContents">도서 상세 요약 및 소개글</label>
                                        ...
                                        <div class="text-right mt-4 pt-2">
                                            ...
                                            <button type="button" class="btn btn-primary px-5 font-weight-bold shadow-sm" id="btn">동기화 및 정보 수정</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
