                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <c:if test="${not empty member and member.username eq dto.username}">
                            <div class="btn-group btn-group-sm">
                                <button type="button" class="btn btn-outline-secondary review_update" 
                                    data-contents="${dto.reviewContents}" 
                                    data-num="${dto.reviewNum}" 
                                    data-rating="${dto.reviewRating}" 
                                    data-toggle="modal" 
                                    data-target="#review_modal">수정</button>
                                <button type="button" class="btn btn-outline-danger review_del" 
                                    data-num="${dto.reviewNum}">삭제</button>
                            </div>
                        </c:if>
                    </div>
                </li>
